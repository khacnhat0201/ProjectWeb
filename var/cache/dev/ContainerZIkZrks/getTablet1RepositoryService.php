 ...
 */
class getTablet1RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Tablet1Repository' shared autowired service.
     *
     * @return \App\Repository\Tablet1Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Tablet1Repository.php';

        return $container->privates['App\\Repository\\Tablet1Repository'] = new \App\Repository\Tablet1Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
