 ...
 */
class getTabletRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TabletRepository' shared autowired service.
     *
     * @return \App\Repository\TabletRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TabletRepository.php';

        return $container->privates['App\\Repository\\TabletRepository'] = new \App\Repository\TabletRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
